...
import { Settings, Bell, Palette, GraduationCap } from "lucide-react"
...
export default function ConfiguracoesProfessorPage() {
  ...
  useEffect(() => {
    ...
    const url = window.localStorage.getItem(`ava:bg:professor`) || ""
    setBgUrlInput(url)
  }, [])
  ...
  function saveBgUrl() {
    try {
      if (bgUrlInput.trim()) {
        window.localStorage.setItem(`ava:bg:professor`, bgUrlInput.trim())
      } else {
        window.localStorage.removeItem(`ava:bg:professor`)
      }
          ...
          <div className="grid gap-6">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">Alertas sobre turmas e atividades</p>
                  </div>
                  <Switch
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure suas preferências de ensino</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label>Horário Preferido para Correções</Label>
                  <select className="w-full p-2 border rounded-md">
