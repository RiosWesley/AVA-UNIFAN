    ...
    <div className={`flex h-screen ${isLiquidGlass ? 'bg-black/30 dark:bg-gray-900/20' : 'bg-background'}`}>
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="p-4 sm:p-6 lg:p-8">
          {/* Header aprimorado */}
          <div className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 sm:mb-8 p-4 sm:p-6 rounded-2xl border backdrop-blur-sm ${
            isLiquidGlass
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="relative">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-purple-600 rounded-2xl flex items-center justify-center shadow-lg">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-purple-600 dark:text-purple-400">
            ...
            <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
              <LiquidGlassButton
                variant="outline"
                size="lg"
                className={`backdrop-blur-sm flex-1 sm:flex-initial ${isLiquidGlass
              ...
              >
                <Database className="h-4 w-4 sm:h-5 sm:w-5 sm:mr-2" />
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="xl:col-span-12 space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                >
                  <CardHeader>
                    <CardTitle className="flex items-center text-sm sm:text-base text-gray-900 dark:text-gray-100">
                      <Users className="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-green-600 dark:text-green-400" />
                      Crescimento de Usuários
                    </CardTitle>
                    <CardDescription className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Evolução mensal por tipo de usuário</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                >
                  <CardHeader>
                    <CardTitle className="flex items-center text-sm sm:text-base text-gray-900 dark:text-gray-100">
                      <DollarSign className="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-emerald-600 dark:text-emerald-400" />
                      Receitas vs Despesas
                    </CardTitle>
                    <CardDescription className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Comparativo financeiro mensal</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="min-h-[250px]">
                      <ResponsiveContainer width="100%" height={300}>
